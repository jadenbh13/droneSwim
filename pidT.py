...
def modulePhase (real, im, xpos,ypos, boolAlt):
	...
	PhaseShiftBase = 0.11810451418294752338511062783797532360802361259259654847
...
def run_sequence(cf, sequence):
	...
	try:
		...
		while True:
			...
			CurrentX, CurrentY = modulePhase(amX, amY, BaseX,BaseY, boolAlt)

			BaseX,BaseY = CurrentX, CurrentY
